#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Hamad Khan
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Hamad Khan
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCnbRkhiw_KT438KBWq784cA?view_as=subscriber')
    else:
...
•\033[1;91m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;93m .....HamadKhan  Kali.linux....... \033[1;91m :
•\033[1;91m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;93m +923159595717"""
